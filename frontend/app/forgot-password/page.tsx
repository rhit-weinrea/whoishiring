      ...
      <div className="w-full max-w-md px-6">
        <div className="rounded-xl p-8 border-2" style={{ background: 'var(--surface)', borderColor: 'var(--outline)' }}>
          <div className="text-center mb-8">
            <i className="bi bi-key text-4xl" style={{ color: 'var(--foreground)' }} aria-hidden="true" />
            <h1 className="text-3xl font-black mt-2" style={{ color: 'var(--foreground)' }}>Reset Password</h1>
          ...
          {submitted ? (
            <div className="text-center space-y-4">
              <div className="p-4 rounded-lg border-2" style={{ borderColor: 'var(--outline)', background: 'var(--background)' }}>
                <i className="bi bi-envelope-check text-2xl mb-2" style={{ color: 'var(--foreground)' }} aria-hidden="true" />
            ...
            <>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                >
                  <span className="inline-flex items-center gap-2">
                    <i className={`bi ${isSubmitting ? 'bi-hourglass' : 'bi-envelope'}`} aria-hidden="true" />
